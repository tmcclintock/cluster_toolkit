int G_at_M_arr(double*M, int NM, double*k, double*P, int Nk, double om,
	       double d, double e, double f, double g, double*G);

int G_at_sigma_arr(double*sigma, int Ns, double d, double e,
		   double f, double g, double*G);

int dndM_at_M_arr(double*M, int NM, double*k, double*P, int Nk, double om,
...
int dndM_sigma2_precomputed(double*M, double*sigma2, double*dsigma2dM,
