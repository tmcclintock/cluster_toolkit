...
def average_profile_in_bin(Rlow, Rhigh, R, prof):
    ...
    """
    return clusterwl._lib.average_profile_in_bin(Rlow, Rhigh, dcat(R), len(R), _dcast(prof))
...
def average_profile_in_bins(Redges, R, prof, ave_prof):
    ...
    """
    return clusterwl._lib.average_profile_in_bins(_dcast(Redges), len(Redges), _dcast(R), len(R), _dcast(prof), _dcast(ave_prof))
